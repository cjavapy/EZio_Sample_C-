...
namespace EzioDll
{
    ...
    public class clsPrinterCommand
    {
        ...
        public int PrintText_Unicode(int PosX, int PosY, int FontHeight, int Align, string FontName, string Data)
        {
            byte[] ByteData = Encoding.Unicode.GetBytes(Data);
            return EZioApi.ecTextOutW_Align(PosX, PosY, FontHeight, Align, FontName, ByteData, Data.Length);
        }
        ...
        public int PrintText_Unicode(int PosX, int PosY, int FontHeight, int Align, string FontName, string Data, int TextWidth, FontWeight Dark, RotateMode Rotate)
        {
            byte[] ByteData = Encoding.Unicode.GetBytes(Data);
            return EZioApi.ecTextOutRW_Align(PosX, PosY, FontHeight, Align, FontName, ByteData, TextWidth, (int)Dark, (int)Rotate, Data.Length);
        }
        ...
        public int PrintText_Unicode(int PosX, int PosY, int FontHeight, int Align, string FontName, string Data, int TextWidth, FontWeight Dark, RotateMode Rotate, Italic_State Italic, Underline_State Underline, Strikeout_State Strikeout, Inverse_State Inverse)
        {
            byte[] ByteData = Encoding.Unicode.GetBytes(Data);
            return EZioApi.ecTextOutFineW_Align(PosX, PosY, FontHeight, Align, FontName, ByteData, TextWidth, (int)Dark, (int)Rotate, (int)Italic, (int)Underline, (int)Strikeout, (int)Inverse, Data.Length);
        }
