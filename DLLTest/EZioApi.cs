...
namespace EzioDll
{
    public class EZioApi
    {
        ...
        [DllImport("Ezio32.dll", CharSet = CharSet.Unicode, CallingConvention = CallingConvention.StdCall)]
        public static extern int ecTextOutW_Align(
          int PosX,
          int PosY,
          int FontHeight,
          int Align,
        ...
        [DllImport("Ezio32.dll", CharSet = CharSet.Unicode, CallingConvention = CallingConvention.StdCall)]
        public static extern int ecTextOutRW_Align(
           int PosX,
           int PosY,
           int FontHeight,
           int Align,
        ...
        [DllImport("Ezio32.dll", CharSet = CharSet.Unicode, CallingConvention = CallingConvention.StdCall)]
        public static extern int ecTextOutFineW_Align(
            int PosX,
            int PosY,
            int FontHeight,
            int Align,
