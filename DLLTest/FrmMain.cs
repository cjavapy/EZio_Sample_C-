...
namespace DLLTest
{
    public partial class FrmMain : Form
    {
        ...
        private void Btn_PrintTextAlign_Click(object sender, EventArgs e)
        {
            int PosX = 200;
            int PosY = 10;
            int FontHeight = 34;
            ...
            // Print Text
            Printer.Command.Start();
            Printer.Command.PrintText_Unicode(PosX, PosY += 40, FontHeight, (int)Align.Center_X, "Arial", "中文");
            Printer.Command.PrintText_Unicode(PosX, PosY += 40, FontHeight, (int)Align.Center_X, "Arial", "中文測試");
            Printer.Command.PrintText_Unicode(PosX, PosY += 40, FontHeight, (int)Align.Center_X, "Arial", "這是中文測試");
            Printer.Command.End();
